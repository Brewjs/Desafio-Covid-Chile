$(() => {
    ...
    //funcion para mostrar grafico con el filtro correspondiente
    const mostrarGrafico = (casosCovid) => {
        const sobre10000 = casosCovid.filter((item) => item.deaths >= 100000)

        //array para la creacion de las columnas con los datos solicitados
        let columnas = [];
    ...
    //funcion para crear tabla en documento html segunn los datos solicitados
    ...
    //funcion para consumir API de los datos totales 
    const covidMundial = () => {
...
//funcion para consumir API con datos por pais
...
//funcion que permite insertar un grafico, para ver detalle por pais en la
